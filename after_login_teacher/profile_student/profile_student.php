    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          ...
          <li class="nav-item active">
          <a class="nav-link" href="../../before_login_student/homepage/homepage.html">LOGOUT</a>
        </li>
              ...
              <div class='modal-dialog'>
                <div class='modal-content'>
                  <div class='modal-header'>
                    <h5 class='modal-title' id='exampleModalLabel' style='color: red;'>Oops!</h5>
                    <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                      <span aria-hidden='true'>&times;</span>
                    </button>
                  </div>
                  <div class='modal-body' style='color: red;'>
                    Full profile can only be viewed by parents or students.
                  </div>
                  <div class='modal-footer'>
                    <button type='button' class='btn btn-secondary' data-dismiss='modal'>Close</button>
                    <button type='button' class='btn btn-primary'><a href='../login/login.html' style='color: antiquewhite;'>login</a></button>
                  </div>
                </div>
              </div>
            </div>
