...
$html="<h1>Welcome</h1><br><h3>One student has tried to show interest in your profile and wants to connect with you</h3><table><tr><td>Name of the student:</td><td>$pname</td></tr><tr><td>Subject he/she is interested:</td><td>$subject</td></tr><tr><td>Number of days he/she wants to study:</td><td>$days</td></tr><tr><td>Timing suitable:</td><td>$timing</td></tr><tr><td>Message</td><td>$info</td></tr></table><br><h3>You may contact with student witch contact number:$contactno</h3>";
include('smtp/PHPMailerAutoload.php');
    ...
    echo $msg;
    if($result){
        header( "location:http://localhost/new/after_login/profile_student/congrats.html");    
    }
    else{
